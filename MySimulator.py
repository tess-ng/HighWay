...
class MySimulator(QObject, PyCustomerSimulator):
    ...
    def afterOneStep(self):
        ...
        # 每秒执行一次
        if my_process.origin_data['timestamp'] == timestamp:
            return
        ...
        print("middle_afterOneStep:", time.time(), len(surplus_cars), len(new_frame_data), len(new_cars))
        ...
        for plat in surplus_cars:
            ...
            if (position_car and position_car[4] == 'L'):  # 仅支持在link上发车
                ...
                dvp.speed = data['origin_speed']  # TODO 是否需要用速度
